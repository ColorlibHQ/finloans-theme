...
// image default alt
if ( ! function_exists( 'finloans_img_default_alt' ) ) {
	function finloans_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'finloans_img_tag' ) ) {
	function finloans_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = finloans_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'finloans_anchor_tag' ) ) {
	function finloans_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'finloans_heading_tag' ) ) {
	function finloans_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'finloans_paragraph_tag' ) ) {
	function finloans_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'finloans_other_tag' ) ) {
	function finloans_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'finloans_button_element ' ) ) {
	function finloans_button_element( array $args ) {
