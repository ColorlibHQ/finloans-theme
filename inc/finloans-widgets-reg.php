...
function finloans_widgets_init() {
    // sidebar widgets register
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar', 'finloans' ),
        'id'            => 'finloans-post-sidebar',
    ...
    // register_sidebar( array(
    //     'name'          => esc_html__( 'Footer One', 'finloans' ),
    //     'id'            => 'footer-1',
    ...
    // ) );
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Two', 'finloans' ),
        'id'            => 'footer-2',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Three', 'finloans' ),
        'id'            => 'footer-3',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Four', 'finloans' ),
        'id'            => 'footer-4',
...
add_action( 'widgets_init', 'finloans_widgets_init' );
