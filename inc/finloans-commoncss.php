...
// enqueue css
function finloans_common_custom_css(){
    
    wp_enqueue_style( 'finloans-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= finloans_opt( 'finloans_theme_color' ) != '#131313' ? finloans_opt( 'finloans_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= finloans_opt( 'finloans_book_btn_color' ) != '#131313' ? finloans_opt('finloans_book_btn_color') : '';
		$bookBtnHoverBgColor     	= finloans_opt( 'finloans_book_btn_hvr_bg_color' ) != '#131313' ? finloans_opt('finloans_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = finloans_opt( 'finloans_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = finloans_opt( 'finloans_navbar_bg_color' ) != '#082b49' ? finloans_opt( 'finloans_navbar_bg_color') : '';
		$headerTop_col     		  = finloans_opt( 'finloans_top_header_color' );

		$headerTopBg      		  = finloans_opt( 'finloans_top_header_bg_color');
		$headerBg          		  = finloans_opt( 'finloans_header_bg_color') != '#ffffff' ? finloans_opt( 'finloans_header_bg_color') : '';
		$menuColor          	  = finloans_opt( 'finloans_header_menu_color' ) != '#131313' ? finloans_opt('finloans_header_menu_color') : '';
		$menuHoverColor           = finloans_opt( 'finloans_header_menu_hover_color' ) != '#808080' ? finloans_opt('finloans_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = finloans_opt( 'finloans_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = finloans_opt( 'finloans_header_drop_menu_bg_color' ) != '#ffffff' ? finloans_opt('finloans_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = finloans_opt( 'finloans_dropdown_menu_color' ) != '#131313' ? finloans_opt('finloans_dropdown_menu_color') : '';
		$dropMenuHovColor         = finloans_opt( 'finloans_dropdown_menu_hover_color' ) != '#808080' ? finloans_opt('finloans_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = finloans_opt( 'finloans_footer_widget_bg_color' );
		$footerwHeadColor   	  = finloans_opt('finloans_footer_widget_heading_color');
		$footerwTextColor   	  = finloans_opt('finloans_footer_widget_text_color');
		$footerwanchorcolor 	  = finloans_opt('finloans_footer_widget_anchor_color') != '#ffffff' ? finloans_opt('finloans_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = finloans_opt('finloans_footer_widget_anchor_hover_color') != '#ffffff' ? finloans_opt('finloans_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = finloans_opt('finloans_fof_bg_color');
		$foftonecolor			  = finloans_opt('finloans_fof_textone_color');
		$fofttwocolor			  = finloans_opt('finloans_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = finloans_opt('finloans_footer_widget_anchor_color') != '#9e9e9e' ? finloans_opt('finloans_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.finloans_part .btn_2, .blog_area a h2:hover
			{
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .finloans_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .finloans_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'finloans-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'finloans_common_custom_css', 50 );