 ...
 */
	...
	$footer_text = finloans_opt( 'finloans_footer_text' ) == '' ? $footer_text : finloans_opt( 'finloans_footer_text' );
				...
				<div class="col-xl-4 col-md-6 col-lg-3">
					<div class="footer_widget wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
						<?php
							...
							// Social profiles
							$social_opt = finloans_opt('finloans_social_profile_toggle');
							if ( $social_opt == true ) {
								$social_items = finloans_opt('finloans_social_profiles');
